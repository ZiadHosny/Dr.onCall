...
export const addDoctor = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
...
export const allDoctors = catchAsyncError(async (req: Request, res: Response) => {
