...
export const sendResponse = ({ res, status, message, page, data }: SendResponseType<string>) => {
...
export const sendLocalizedResponse = ({ req, res, status, message, page, data }: SendLocalizedType) => {
