              ...
              <tr>
                <td align="center" valign="top" style="padding: 36px 24px;">
                  <a href="${appUrl}" target="_blank" style="display: inline-block;">
                    <img src="${appImg}" alt="Logo" border="0" 
              ...
              <tr>
                <td align="left" bgcolor="#ffffff"
                  ...
                  <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account
                    with <a href="${appUrl}">Paste</a>, you can safely delete this email.</p>
                </td>
              </tr>
              <tr>
                <td align="left" bgcolor="#ffffff">
          ...
          <td align="center" bgcolor="#e9ecef" style="padding: 24px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <!-- <tr>
                <td align="center" bgcolor="#e9ecef"
                  style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                  <p style="margin: 0;">To stop receiving these emails, you can <a href="${appUrl}"
