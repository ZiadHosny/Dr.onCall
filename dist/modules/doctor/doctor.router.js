...
router
    .route('/')
    .all(auth)
    .post(allowedTo(Role.SuperAdmin, Role.Admin), validation(createDoctorSchema, 'body'), addDoctor)
    .get(allDoctors);
router.put('/:id', allowedTo(Role.SuperAdmin, Role.Admin), validation(updateDoctorSchema, 'body'), updateDoctor);
