...
import { addNewSymptom, allSymptoms, deleteSymptom, getSymptomById, updateSymptom, } from './symptom.controller.js';
...
router
    .route('/')
    .all(auth)
    .post(allowedTo(Role.SuperAdmin, Role.Admin), validation(symptomSchema, 'body'), addNewSymptom)
    .get(allSymptoms);
router
    .route('/:id')
